...
#
# Pipeline adapted from Hugging Face diffusers (QwenImagePipeline).
    ...
    def __call__(
        ...
        Args:
            ...
            guidance_scale (`float`, *optional*, defaults to None):
                A guidance scale value for guidance distilled models.
            ...
            target_resolution (`int`, *optional*): Target resolution in pixels for dynamic NTK-RoPE scaling.
                Defaults to max(height, width).
        ...
        # Don't default target_resolution to max(h,w) — let the transformer
        # compute per-axis NTK factors from the actual image dimensions.
        # Users can still pass an explicit target_resolution to override.
