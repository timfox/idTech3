...
### Added
- **OpenArena playbook:** `docs/OPENARENA.md`, `scripts/run_openarena.sh`, `r_classicMod` / `classic_mod` preset for QVM-safe Vulkan (Forward+, volumetrics, RTX, VDB off at init; generative hooks off via console).
