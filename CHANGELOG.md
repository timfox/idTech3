...
### Added
- **OpenArena playbook:** `docs/OPENARENA.md`, `scripts/run_openarena.sh` (`OA_BASE`, `CLASSIC_MOD=1`), `examples/q3_classic_mod.cfg`, release `examples/*.cfg` copy on build; `r_classicMod` / `classic_mod` preset for QVM-safe Vulkan.
