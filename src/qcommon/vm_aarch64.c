...
#define MOVZ32(Rd,imm16)        ( (0u<<31) /*sf*/ | (0xA5u<<23) | (0u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )
#define MOVZ32_16(Rd,imm16)     ( (0u<<31) /*sf*/ | (0xA5u<<23) | (1u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )
#define MOVZ64(Rd,imm16)        ( (1u<<31) /*sf*/ | (0xA5u<<23) | (0u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )

#define MOVK32_16(Rd,imm16)     ( (0u<<31) /*sf*/ | (0xE5u<<23) | (1u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )
#define MOVK64_16(Rd,imm16)     ( (1u<<31) /*sf*/ | (0xE5u<<23) | (1u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )
#define MOVK64_32(Rd,imm16)     ( (1u<<31) /*sf*/ | (0xE5u<<23) | (2u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )
#define MOVK64_48(Rd,imm16)     ( (1u<<31) /*sf*/ | (0xE5u<<23) | (3u<<21) | (((imm16)&0xFFFFu)<<5) | Rd )

#define MOVN32(Rd,imm16)        ( (0<<31) /*sf*/ | (0b00100101<<23) | (0b00<<21) | ((imm16&0xFFFF)<<5) | Rd )
#define MOVN32_16(Rd,imm16)     ( (0u<<31) /*sf*/ | (0x25u<<23) | (1u<<21) | ((imm16&0xFFFFu)<<5) | Rd )
#define MOVN64(Rd,imm16)        ( (1u<<31) /*sf*/ | (0x25u<<23) | (0u<<21) | ((imm16&0xFFFFu)<<5) | Rd )
#define MOVN64_16(Rd,imm16)     ( (1u<<31) /*sf*/ | (0x25u<<23) | (1u<<21) | ((imm16&0xFFFFu)<<5) | Rd )
#define MOVN64_32(Rd,imm16)     ( (1u<<31) /*sf*/ | (0x25u<<23) | (2u<<21) | ((imm16&0xFFFFu)<<5) | Rd )
#define MOVN64_48(Rd,imm16)     ( (1u<<31) /*sf*/ | (0x25u<<23) | (3u<<21) | ((imm16&0xFFFFu)<<5) | Rd )

#define ORR32(Rd, Rn, Rm)       ( (0u<<31) /*sf*/ | (0x2Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )
#define ORR64(Rd, Rn, Rm)       ( (1u<<31) /*sf*/ | (0x2Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )

#define EOR32(Rd, Rn, Rm)       ( (0u<<31) /*sf*/ | (0x4Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )
#define EOR64(Rd, Rn, Rm)       ( (1u<<31) /*sf*/ | (0x4Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )

#define AND32(Rd, Rn, Rm)       ( (0u<<31) /*sf*/ | (0x0Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )
#define AND64(Rd, Rn, Rm)       ( (1u<<31) /*sf*/ | (0x0Au<<24) | (0u<<22) /*shift*/ | (0u<<21) /*N*/ | (Rm<<16) | (0u<<10) /*imm6*/ | (Rn<<5) | Rd )

#define AND32i(Rd, Rn, immrs)   ( (0u<<31) /*sf*/ | (0u<<29) | (0x24u<<23) | ((immrs) << 10) | ((Rn)<<5) | (Rd) )
#define ORR32i(Rd, Rn, immrs)   ( (0u<<31) /*sf*/ | (0x20000000u) | (0x24u<<23) | ((immrs) << 10) | ((Rn)<<5) | (Rd) )
#define EOR32i(Rd, Rn, immrs)   ( (0u<<31) /*sf*/ | (0x80000000u) | (0x24u<<23) | ((immrs) << 10) | ((Rn)<<5) | (Rd) )
