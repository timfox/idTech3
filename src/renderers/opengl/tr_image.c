...
static void R_CreateBuiltinImages( void ) {
	...
	tr.checkerImage = R_CreateImage( "*checker", NULL, (byte *)data, DEFAULT_SIZE, DEFAULT_SIZE, IMGFLAG_MIPMAP );
	...
	tr.gridImage = R_CreateImage( "*grid", NULL, (byte *)data, DEFAULT_SIZE, DEFAULT_SIZE, IMGFLAG_MIPMAP );
	...
	tr.noiseImage = R_CreateImage( "*noise", NULL, (byte *)data, DEFAULT_SIZE, DEFAULT_SIZE, IMGFLAG_MIPMAP );
