...
extern glconfig_t	glConfig __attribute__((visibility("hidden")));		// outside of TR since it shouldn't be cleared during ref re-init
...
extern qboolean  nonPowerOfTwoTextures __attribute__((visibility("hidden")));
extern qboolean  textureFilterAnisotropic __attribute__((visibility("hidden")));
extern int       maxAnisotropy __attribute__((visibility("hidden")));
