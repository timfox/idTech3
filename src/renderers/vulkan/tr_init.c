...
cvar_t	*r_glints_scale;
cvar_t	*r_glints_anisotropy;
cvar_t	*r_glints_anisoRotation;
cvar_t	*r_glints_slopeVariance;
cvar_t	*r_glints_seed;
cvar_t	*r_glints_samples;
cvar_t	*r_glints_lod;
cvar_t	*r_glints_filter;
cvar_t	*r_glints_tileSize;
cvar_t	*r_glints_mipBias;
cvar_t	*r_glints_temporal;
cvar_t	*r_glints_taaWeight;
cvar_t	*r_glints_historyClamp;
cvar_t	*r_glints_jitter;
cvar_t	*r_glints_maxLuminance;
cvar_t	*r_glints_fireflyFilter;
cvar_t	*r_glints_energyComp;
cvar_t	*r_glints_fresnel;
cvar_t	*r_glints_f0Override;
cvar_t	*r_glints_halfRes;
cvar_t	*r_glints_maxDistance;
cvar_t	*r_glints_maxScreenSlope;
cvar_t	*r_glints_budgetMs;
cvar_t	*r_glints_affectIBL;
cvar_t	*r_glints_affectDirect;
cvar_t	*r_glints_shadowed;
cvar_t	*r_glints_beta;
cvar_t	*r_glints_ax;
cvar_t	*r_glints_ay;
cvar_t	*r_glints_rho;
cvar_t	*r_glints_lnrho;
cvar_t	*r_glints_zeta;
cvar_t	*r_glints_gamma;
cvar_t	*r_glints_dict_levels;
cvar_t	*r_glints_dict_size;
cvar_t	*r_glints_dict_count;
cvar_t	*r_glints_dict_alpha;
cvar_t	*r_glints_dict_lobeSigma;
cvar_t	*r_glints_dict_reload;
cvar_t	*r_glints_masking;
cvar_t	*r_glints_energy_debug;
cvar_t	*r_glints_maxCells;
cvar_t	*r_glints_lodBias;
...
static void R_Register( void )
{
	...
	r_glints_temporal = ri.Cvar_Get( "r_glints_temporal", "1", CVAR_ARCHIVE_ND );
	r_glints_taaWeight = ri.Cvar_Get( "r_glints_taaWeight", "0.9", CVAR_ARCHIVE_ND );
	r_glints_historyClamp = ri.Cvar_Get( "r_glints_historyClamp", "2", CVAR_ARCHIVE_ND );
	r_glints_jitter = ri.Cvar_Get( "r_glints_jitter", "1", CVAR_ARCHIVE_ND );
	r_glints_maxLuminance = ri.Cvar_Get( "r_glints_maxLuminance", "2000", CVAR_ARCHIVE_ND );
	r_glints_fireflyFilter = ri.Cvar_Get( "r_glints_fireflyFilter", "1", CVAR_ARCHIVE_ND );
	r_glints_energyComp = ri.Cvar_Get( "r_glints_energyComp", "1", CVAR_ARCHIVE_ND );
	...
	r_glints_ax = ri.Cvar_Get( "r_glints_ax", "1", CVAR_ARCHIVE_ND );
	r_glints_ay = ri.Cvar_Get( "r_glints_ay", "1", CVAR_ARCHIVE_ND );
	r_glints_rho = ri.Cvar_Get( "r_glints_rho", "20", CVAR_ARCHIVE_ND );
	r_glints_lnrho = ri.Cvar_Get( "r_glints_lnrho", "20", CVAR_ARCHIVE_ND );
	...
	r_vk_shaderReload = ri.Cvar_Get( "r_vk_shaderReload", "0", CVAR_ARCHIVE_ND );
	ri.Cvar_SetDescription( r_vk_shaderReload, "Log shader metadata changes and hint at running scripts/shader_worker_pool.sh when iterating on shaders." );
