...
Q_EXPORT cvar_t	*r_rt_temporal;
Q_EXPORT cvar_t	*r_rt_temporalAlpha;
Q_EXPORT cvar_t	*r_rt_blasCompaction;
Q_EXPORT cvar_t	*r_rt_blasReuse;
Q_EXPORT cvar_t	*r_rt_denoise;
Q_EXPORT cvar_t	*r_rt_denoiseMode;
Q_EXPORT cvar_t	*r_rt_denoiseIterations;
Q_EXPORT cvar_t	*r_rt_denoiseSpatialAlpha;
Q_EXPORT cvar_t	*r_rt_denoiseVarianceAlpha;
Q_EXPORT cvar_t	*r_rt_outputScale;
Q_EXPORT cvar_t	*r_rt_shadowRays;
Q_EXPORT cvar_t	*r_rt_adaptiveSampling;
Q_EXPORT cvar_t	*r_rt_gi;
Q_EXPORT cvar_t	*r_rt_giBounces;
Q_EXPORT cvar_t	*r_rt_giIntensity;
...
===============
*/
static ID_INLINE void R_Radix( int byte_index, int size, const drawSurf_t *source, drawSurf_t *dest )
{
  int           count[ 256 ] = { 0 };
  int           index[ 256 ];
  int           i;
  ...
  sortKey = ( (unsigned char *)&source[ 0 ].sort ) + byte_index;
