...
/* Instance-level function pointers (assigned by init, used by create_instance/vk_destroy_instance) */
...
/* Device-level function pointers (assigned by init, used by vk_create_device and elsewhere) */
