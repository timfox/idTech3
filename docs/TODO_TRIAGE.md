...
| r_renderMode 1 | tr_init.c, tr_render_mode_vk.c | Deferred lighting **not implemented**; forward fallback. **`r_deferredGBuffer 1`** allocates scaffold RTs (albedo/normal/material). |
