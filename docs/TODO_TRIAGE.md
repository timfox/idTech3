...
| Surfel GI (GIBS) | `vk_surfel_gi.c` | **PARTIAL**: Chocolate RTX path — spawn from G-buffer, ray-query update vs shared TLAS, resolve + composite. Spatial hash / hit albedo / recycling still open. See `docs/SURFEL_GI.md`. |
