...
| Deferred renderer | — | Not started; main Vulkan path is forward + optional **`r_forwardPlus`** tile cull (default **1**). Full deferred would need G-buffers and separate passes. |
