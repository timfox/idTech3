...
Evidence for **Tier B** (automated + `GAME_BASE`) and **Tier C** (manual GPU / validation layers).
...
| [FINDINGS.md](FINDINGS.md) | Rolling log of completed Tier C sessions (optional; commit when you have GPU proof) |
