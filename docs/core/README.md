...
Engine foundation, build, compatibility, and repository layout.

| Doc | Topic |
|-----|--------|
| [ARCHITECTURE.md](../ARCHITECTURE.md) | Layer cake overview |
| [COMPATIBILITY.md](../COMPATIBILITY.md) | QVM, pk3, mod loading |
| [BUILD.md](../../BUILD.md) | Build profiles and CMake |
| [DEVELOPMENT_SETUP.md](../DEVELOPMENT_SETUP.md) | Toolchain setup |
