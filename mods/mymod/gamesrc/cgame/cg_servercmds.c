...
=================
*/
static void CG_VoiceChat( [[maybe_unused]] int mode ) {
#ifdef MISSIONPACK
	const char *cmd;
	int clientNum, color;
	qboolean voiceOnly;
...
static void CG_ServerCommand( void ) {
	...
	if ( Q_strequal( cmd, "dialog" ) ) {
		...
		CG_Dialog_Show( id, pageNum, speaker, dialogText, numChoices, choices, targets );
		return;
	}
