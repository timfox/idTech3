/*
===========================================================================
BSP47 / Apex Legends BSP v47 renderer bridge.

BSP47 faces are reconstructed from edges and surfedges and submitted as
...
(Apex Legends luxel grid, style 0) so surfaces are not fullbright albedo.

This is an independent binary-format implementation. It does not include or
depend on Apex Legends source, headers, or libraries.
===========================================================================
*/
