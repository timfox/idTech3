/*
===========================================================================
BSP37 Titanfall 2 BSP renderer bridge.

BSP37 faces are reconstructed from edges and surfedges and submitted as
...
(Titanfall 2 luxel grid, style 0) so surfaces are not fullbright albedo.

This is an independent binary-format implementation. It does not include or
depend on Titanfall 2 source, headers, or libraries.
===========================================================================
*/
