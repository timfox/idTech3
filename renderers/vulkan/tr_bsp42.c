/*
===========================================================================
BSP42 / 007: Nightfire BSP v42 renderer bridge.

BSP42 faces are reconstructed from edges and surfedges and submitted as
...
(007: Nightfire luxel grid, style 0) so surfaces are not fullbright albedo.

This is an independent binary-format implementation. It does not include or
depend on 007: Nightfire source, headers, or libraries.
===========================================================================
*/
