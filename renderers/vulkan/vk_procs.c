...
PFN_vkCmdDrawMeshTasksNV							qvkCmdDrawMeshTasksNV;
...
PFN_vkGetImageSparseMemoryRequirements			qvkGetImageSparseMemoryRequirements;
...
PFN_vkQueueBindSparse							qvkQueueBindSparse;
