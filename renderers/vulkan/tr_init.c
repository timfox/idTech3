...
static void R_Register( void )
{
	...
	ri.Cvar_SetDescription( r_vk_meshShaderNV,
		"Request VK_NV_mesh_shader at device creation (NVIDIA). Default off: virtual geometry uses meshlet MDI as the portable production path, with mesh-shader experiments gated behind this cvar. "
		"Also enables Loop&Blinn glyphlet string dispatch probes (r_vectorFontMode 2, AMD GPUOpen). Requires vid_restart." );
