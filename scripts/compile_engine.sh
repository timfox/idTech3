...
if [ "$STEAM" -eq 1 ]; then
  ...
  echo "CMake: USE_STEAM=ON STEAMWORKS_SDK=${STEAMWORKS_SDK_PATH} (default; pass 'no-steam' to disable)"
else
  CMAKE_FLAGS+=("-DUSE_STEAM=OFF")
  echo "CMake: USE_STEAM=OFF"
fi
...
copy_to_release() {
  ...
  if [ -f "$PROJECT_ROOT/config/openhmd.cfg" ]; then
    cp -f "$PROJECT_ROOT/config/openhmd.cfg" "$dest/base/openhmd.cfg"
  fi
  for cfg in classic_baseq3.cfg modern_vulkan.cfg modern_vulkan_stable.cfg modern_vulkan_quality.cfg modern_vulkan_rt.cfg modern_vulkan_experimental.cfg gfx_safe.cfg demo_gbuffer_av_lifecycle.cfg demo_rts_0ad.cfg modern_clustered.cfg deferred_vulkan.cfg demo_deferred_many_lights.cfg vulkan_overlay_deferred.cfg vulkan_overlay_unified_clustered.cfg vulkan_overlay_unified_clustered_safe.cfg vulkan_overlay_oit_clustered.cfg demo_wboit_parity.cfg demo_wboit_stress_mode3.cfg demo_wboit_fog_layers.cfg vulkan_overlay_spine_1_1_cert.cfg vulkan_overlay_selective_hybrid.cfg vulkan_overlay_pt_reference.cfg vulkan_overlay_visibility_2027.cfg vulkan_overlay_rtx.cfg vulkan_overlay_hybrid1.cfg vulkan_overlay_aa_sharp.cfg vulkan_overlay_temporal_recon.cfg vulkan_overlay_temporal_perf.cfg modern_native.cfg modern_openarena.cfg modern_lighting.cfg console_ttf.cfg console_sdf.cfg modern_raster_reference.cfg modern_raster_ultra.cfg modern_low_latency.cfg modern_experimental.cfg vulkan_overlay_raster_ultra_1_6_geometry.cfg vulkan_overlay_raster_ultra_1_7_atmosphere.cfg vulkan_overlay_raster_ultra_1_8_materials.cfg vulkan_overlay_raster_ultra_1_9_virtual_shadows.cfg vulkan_overlay_raster_ultra_1_10_hdr_presentation.cfg vulkan_overlay_raster_ultra_1_11_reference_lab.cfg vulkan_overlay_frequency_aware.cfg vulkan_overlay_raster_ultra_1_13_radiance_cache.cfg demo_oit_isolation.cfg repro_oit_corruption.cfg; do
