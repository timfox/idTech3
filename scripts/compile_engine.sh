...
copy_to_release() {
  ...
  for cfg in classic_baseq3.cfg modern_vulkan.cfg modern_clustered.cfg deferred_vulkan.cfg vulkan_overlay_deferred.cfg vulkan_overlay_unified_clustered.cfg vulkan_overlay_unified_clustered_safe.cfg vulkan_overlay_oit_clustered.cfg vulkan_overlay_visibility_2027.cfg vulkan_overlay_rtx.cfg vulkan_overlay_hybrid1.cfg modern_native.cfg modern_lighting.cfg console_ttf.cfg console_sdf.cfg; do
