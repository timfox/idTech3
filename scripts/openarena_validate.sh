...
echo "--- 1/4 q3_openarena_compat_check ---"
./scripts/q3_openarena_compat_check.sh "$RELEASE_DIR"
echo ""

echo "--- 2/4 test_run_openarena (launcher regression) ---"
