...
typedef enum {
	...
	G_ENGINE_SPRITE_SHADER_INDEX,	/* int trap_EngineSpriteShaderIndex( const char *shaderPath ) */
	...
	G_PHYS_APPLYFORCE,
	G_PHYS_APPLYIMPULSE,
	G_PHYS_GETBODYTRANSFORM,
	G_PHYS_SETBODYTRANSFORM,
	G_PHYS_SETBODYVELOCITY,
	G_PHYS_RAYCAST,
