...
#define CS_ENGINE_DECAL_SHADERS		(CS_ENGINE_SPRITE_META+1)
#define MAX_ENGINE_DECAL_SHADERS	256
#define CS_ENGINE_DECAL_META		(CS_ENGINE_DECAL_SHADERS+MAX_ENGINE_DECAL_SHADERS)

#define CS_ENGINE_OPENWORLD_SECTORS	(CS_ENGINE_DECAL_META+1)

#define CS_ENGINE_WORLD_CONFIG		(CS_ENGINE_OPENWORLD_SECTORS+1)

#define CS_MAX					(CS_ENGINE_WORLD_CONFIG+1)
