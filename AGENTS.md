...
- **No automated test suite**: There is no `make test` or `ctest` target. Validation is done via successful builds across compiler/config matrix (see `.github/workflows/build.yml`) and manual testing.
