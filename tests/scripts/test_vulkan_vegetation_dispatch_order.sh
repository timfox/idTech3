...
VK_FRAME_SUBMIT_DEFAULT="$(idtech3_file renderers/vulkan/vk_frame_submit.c src/renderers/vulkan/vk_frame_submit.c)"
TR_SHADE_FILE="${1:-$TR_SHADE_DEFAULT}"
VK_FRAME_SUBMIT_FILE="${2:-$VK_FRAME_SUBMIT_DEFAULT}"
