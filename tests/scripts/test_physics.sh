...
LUA_PHYSICS="runtime/game/scripting/g_lua_physics_bindings.inc"
test -f "$LUA_PHYSICS"
...
rg -q 'createRagdoll' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
rg -q 'subscribe' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
...
rg -q 'setFriction' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
rg -q 'validateReplay' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
rg -q 'pollEvent' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
...
rg -q 'spawnBoundAlive' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
rg -q 'createDmm' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
...
rg -q 'getClosestPoint' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
rg -q 'sphereTOI' runtime/game/scripting/g_lua_bindings.c "$LUA_PHYSICS"
...
rg -q 'setTargetTransform' runtime/game/scripting/g_lua_registration.inc
