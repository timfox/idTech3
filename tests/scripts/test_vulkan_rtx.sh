...
check "$ROOT/renderers/vulkan/vk_selective_rt.c" 'r_selectiveRayTracing' 'selective RT master gate'
check "$ROOT/renderers/vulkan/vk_selective_rt.c" 'r_selectiveShadowBudget' 'selective shadow budget'
check "$ROOT/renderers/vulkan/vk_selective_rt.c" 'r_selectiveReflectionBudget' 'selective reflection budget'
check "$ROOT/renderers/vulkan/vk_selective_rt.c" 'r_selectiveHeroObjectBudget' 'hero object budget'
check "$ROOT/renderers/vulkan/vk_selective_sun_shadow.c" 'vk_srt_admit_shadow' 'shadow admission routing'
check "$ROOT/renderers/vulkan/vk_selective_reflection.c" 'vk_srt_admit_reflection' 'reflection admission routing'
check "$VK_ENT" 'vk_srt_admit_hero_object' 'hero object admission routing'
