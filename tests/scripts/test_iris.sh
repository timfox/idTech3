...
grep -q 'iris_load' "$ROOT/src/renderers/vulkan/extensions/scaffold/vk_iris.c"
grep -q 'mipBilinear' "$ROOT/src/renderers/vulkan/shaders/glsl/iris/iris_compose.comp"
grep -q 'Iris_DispatchSpdForHrTiles' "$ROOT/src/renderers/vulkan/extensions/scaffold/vk_iris.c"
grep -q 'iris_overlay.comp' "$ROOT/scripts/compile_shaders.sh"
grep -q 'r_iris_bilinear' "$ROOT/src/renderers/vulkan/extensions/scaffold/vk_iris.c"
