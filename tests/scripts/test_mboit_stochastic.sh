...
rg -q 'oit_mboit_coverage_from_b0' "$ROOT/renderers/vulkan/shaders/glsl/oit_resolve.frag" || fail "MBOIT resolve must use optical-depth coverage"
rg -q 'pc.oitMode == 2.*oit_mboit_coverage_from_b0|oit_mboit_coverage_from_b0.*pc.oitMode == 2' "$ROOT/renderers/vulkan/shaders/glsl/oit_resolve.frag" || fail "MBOIT resolve branch missing"
rg -q 'mode == 20' "$ROOT/renderers/vulkan/shaders/glsl/oit_resolve.frag" || fail "MBOIT coverage debug view missing"
rg -q 'mode == 21' "$ROOT/renderers/vulkan/shaders/glsl/oit_resolve.frag" || fail "MBOIT mean-depth debug view missing"
rg -q 'unit_mboit_resolve' "$ROOT/CMakeLists.txt" || fail "MBOIT resolve unit missing"
