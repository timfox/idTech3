...
grep -q 'VudaCuda_WaitRenderTimeline' "$ROOT/src/extensions/research/vuda/vuda_cuda.h"
...
grep -q 'vuda_step_async' "$ROOT/runtime/client/cl_vuda.c"
grep -q 'vuda_wait_step' "$ROOT/runtime/client/cl_vuda.c"
