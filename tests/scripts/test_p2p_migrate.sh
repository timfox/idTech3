...
grep -q 'p2pmigrate' runtime/server/sv_main.c || fail "missing advertised p2pmigrate info key"
grep -q 'sv_p2pHostMigration' runtime/server/sv_init.c || fail "missing sv_p2pHostMigration cvar"
