...
source_checks() {
	...
	check_grep "$stable" 'seta r_renderMode 2' "stable profile selects Forward+ mode 2"
	...
	check_grep "$stable" 'seta r_deferredLighting 0' "stable profile keeps deferred lighting off in mode 2"
