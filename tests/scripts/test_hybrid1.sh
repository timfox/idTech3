...
grep -q 'vk_hybrid1_record_pass' "$ROOT/src/renderers/vulkan/vk_hybrid1.c"
...
test -f "$ROOT/src/renderers/vulkan/vk_hybrid1_spirv.inc"
...
grep -q 'hybrid1_reset' "$ROOT/src/renderers/vulkan/vk_hybrid1.c"
grep -q 'hybrid1_reload' "$ROOT/src/renderers/vulkan/vk_hybrid1.c"
grep -q 'HYBRID1_ConsumeCvarResets' "$ROOT/src/renderers/vulkan/vk_hybrid1.c"
