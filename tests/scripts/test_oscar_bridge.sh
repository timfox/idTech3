#!/usr/bin/env bash
# OSCAR source guard: direct raw OSCAR plus optional gateway bridge + hybrid AIM shell.
set -euo pipefail
...
rg -q 'Engine.Oscar|\"Oscar\"' runtime/server/sv_app_crdt.c runtime/client/core/cl_oscar.c || fail "missing Lua Engine.Oscar table"
rg -q 'BuddyCount|GetBuddy' runtime/server/sv_app_crdt.c runtime/client/core/cl_oscar.c || fail "missing Lua OSCAR buddy roster bindings"
