...
rg -q 'info_director_spawn' "$ROOT/runtime/game/g_entity_bridge.c" || fail "director spawn wire"
...
rg -q 'WorldConfig' "$ROOT/runtime/game/g_lua_registration.inc" || fail "Lua WorldConfig"
