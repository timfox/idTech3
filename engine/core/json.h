...
static JSON_MAYBE_UNUSED const char *JSON_ArrayGetFirstValue(const char *json, const char *jsonEnd);
...
static JSON_MAYBE_UNUSED const char *JSON_ArrayGetNextValue(const char *json, const char *jsonEnd);
...
static JSON_MAYBE_UNUSED unsigned int JSON_ArrayGetIndex(const char *json, const char *jsonEnd, const char **indexes, unsigned int numIndexes);

// Get pointer to indexed value from array
// returns NULL if not an array, no index, or out of data
static JSON_MAYBE_UNUSED const char *JSON_ArrayGetValue(const char *json, const char *jsonEnd, unsigned int index);
...
static JSON_MAYBE_UNUSED const char *JSON_ObjectGetNamedValue(const char *json, const char *jsonEnd, const char *name);
...
static JSON_MAYBE_UNUSED unsigned int JSON_ValueGetType(const char *json, const char *jsonEnd);
...
static JSON_MAYBE_UNUSED unsigned int JSON_ValueGetString(const char *json, const char *jsonEnd, char *outString, unsigned int stringLen);

// Get value as appropriate type
// returns 0 if value is false, value is null, or out of data
// returns 1 if value is true
// returns value otherwise
static JSON_MAYBE_UNUSED double JSON_ValueGetDouble(const char *json, const char *jsonEnd);
static JSON_MAYBE_UNUSED float JSON_ValueGetFloat(const char *json, const char *jsonEnd);
static JSON_MAYBE_UNUSED int JSON_ValueGetInt(const char *json, const char *jsonEnd);
